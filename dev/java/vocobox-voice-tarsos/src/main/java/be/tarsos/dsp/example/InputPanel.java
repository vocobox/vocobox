...
public class InputPanel extends JPanel {
	...
	public InputPanel(){
		...
		this.add(new JScrollPane(buttonPanel,ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER),BorderLayout.CENTER);
