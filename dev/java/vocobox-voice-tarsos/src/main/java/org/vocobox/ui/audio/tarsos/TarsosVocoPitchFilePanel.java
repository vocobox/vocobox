        ...
        chooseFileButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    try {
                        pitchFile.play(file, estimationGainSlider.getValue() / 100.0, sourceGainSlider.getValue() / 100.0);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                } else {
        ...
        return new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                if (pitchFile.currentFile != null) {
                    ...
                    try {
                        pitchFile.play(pitchFile.currentFile, estimationGainSlider.getValue() / 100.0, sourceGainSlider.getValue() / 100.0);
                    } catch (Exception e1) {
