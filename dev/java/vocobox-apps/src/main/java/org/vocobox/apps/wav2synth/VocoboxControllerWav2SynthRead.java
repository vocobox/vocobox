 ...
 */
public class VocoboxControllerWav2SynthRead extends VocoboxControllerAbstract {
	public static void main(String[] args) throws Exception,
			UnsupportedAudioFileException {
		VocoboxControllerWav2SynthRead controller = new VocoboxControllerWav2SynthRead();
controller.play("data/sound/doremi-mono.wav");
	...
	/* ######################################################## */
	   ...
	   public static void exportCoran(VocoboxControllerWav2SynthRead controller) throws FileNotFoundException, IOException, Exception{
	        String file ;
	        String out;
	...
	public static void exportVoice2(VocoboxControllerWav2SynthRead controller) throws FileNotFoundException, IOException, Exception{
		String file ;
		String out;
	...
	public static void exportDoremi(VocoboxControllerWav2SynthRead controller) throws FileNotFoundException, IOException, Exception{
		String file ;
		String out;
	...
	public static void exportPiano(VocoboxControllerWav2SynthRead controller) throws FileNotFoundException, IOException, Exception{
		String file ;
		String out;
	...
	private static void exportBlocking(VocoboxControllerWav2SynthRead controller,
	...
	public void loadUI() throws IOException {
		...
		panels.setInputControl(new TransportPanel(new On() {
			...
			public void play() {
				try {
					VocoboxControllerWav2SynthRead.this.play();
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
			...
			@Override
			public void stop() {
				VocoboxControllerWav2SynthRead.this.stop();
